...
In dem Grundzustand ergibt sich im Grundzustand für beide Isotope $J = S =$\sfrac{1}{2}, da nur ein Hüllenelektron vorhanden ist.
...
$I = $\sfrac{3}{2} ergibt. Die Energieniveaus spalten sich in verschiedene $F$-Energielevel. 
...
Die Energiedifferenzen, welche durch die Hyperfeinstruktur und den Zeemann-Effekt auftreten sind klein genug um die Niveaus als Äquivalent anzusehen, wenn sie angeregt werden.
